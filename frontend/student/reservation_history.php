<?php
// frontend/student/reservation_history.php
...
$result       = djangoGet('/api/v1/reservations/history/?user_id=' . $user_id);
$reservations = [];
...
<div class="page-header">
    <div class="page-header-left">
        <h1 class="page-title">My Reservation History</h1>
        <p class="page-subtitle">All your past and present reservations.</p>
    </div>
    <button onclick="printHistory()" class="btn btn-secondary">🖨️ Print</button>
</div>

<div class="filter-bar">
    <input type="text" id="searchRes" class="form-control" placeholder="Search..." style="min-width:220px;">
...
<div class="print-header" style="display:none;">
    <h2>Spacio — My Reservation History</h2>
...
function downloadPDF() {
    ...
    const doc = new jsPDF();
    doc.setFontSize(14);
    doc.text('Spacio — My Reservation History', 14, 15);
    doc.setFontSize(9);
    ...
    doc.autoTable({
        startY: 27,
        head: [['#','Type','Name','Date','Time Slot','Status','Submitted']],
        body: rows,
        styles: { fontSize: 8 },
        headStyles: { fillColor: [44, 95, 45] },
    });

    doc.save('my_reservation_history.pdf');
}
</script>
