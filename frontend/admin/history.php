...
<div class="page-header">
    <div class="page-header-left">
        ...
        <p class="page-subtitle">Complete record of all reservations in the system.</p>
    </div>
...
<div class="filter-bar">
    <input type="text" id="searchRes" class="form-control" placeholder="Search student, lab, equipment..." style="min-width:240px;">
    ...
    <span class="filter-summary"><?php echo count($reservations); ?> total record(s)</span>
</div>

<div id="printArea">
<div class="print-header" style="display:none;">
    <h2>Spacio — Full Reservation History</h2>
            ...
            <tr>
                <td colspan="8">
                    <div class="empty-state">
                        ...
                        <p class="empty-state-text">No reservations on record.</p>
                    </div>
                </td>
            </tr>
        <?php else: ?>
...
function downloadPDF() {
    ...
    const doc = new jsPDF();
    doc.setFontSize(14);
    doc.text('Spacio — Full Reservation History', 14, 15);
    doc.setFontSize(9);
    ...
    doc.save('full_reservation_history.pdf');
}
</script>
